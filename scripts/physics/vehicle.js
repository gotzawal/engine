class Vehicle extends pc.Script {
...
pc.registerScript(Vehicle);


class VehicleWheel extends pc.Script {
...
pc.registerScript(VehicleWheel);


class VehicleControls extends pc.Script {
    static scriptName = 'vehicleControls';
...
pc.registerScript(VehicleControls);
